          ...
          <div className="card" style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
              ...
              >
                ...
                <option value="upload">Tệp tải lên</option>
                <option value="manual">Nhập thủ công</option>
                <option value="web">Website cào</option>
            ...
            <div className="card" style={{ flex: '1.6 1 450px', padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1.25rem', border: '1px solid var(--color-border-light)' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', flex: 1 }}>
                ...
                <textarea
                  ...
                  style={{ fontSize: '0.8125rem', lineHeight: 1.5, flex: 1, minHeight: '260px' }}
                />
        ...
        <div style={{
          ...
          <div className="card" style={{ width: '100%', maxWidth: '600px', padding: '2rem', display: 'flex', flexDirection: 'column', gap: '1.25rem', margin: '1rem' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
              ...
              <select
                value={webFolderId}
                onChange={e => setWebFolderId(e.target.value)}
                className="form-input"
              >
                <option value="">-- Lưu riêng lẻ ở thư mục gốc (Root) --</option>
                {folderOptions.map(f => (
