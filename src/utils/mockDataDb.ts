export const INITIAL_MOCK_DB = {
  ...
  check_ins: [
    { id: 1, user_id: 1, check_in_date: '2026-07-01', check_in_time: '07:45:00', selfie_url: 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?auto=format&fit=crop&w=150', status: 'approved', reason: null },
    { id: 2, user_id: 2, check_in_date: '2026-07-01', check_in_time: '08:15:00', selfie_url: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=150', status: 'pending_approval', reason: 'Kẹt xe đường Nguyễn Hữu Cảnh' },
    { id: 3, user_id: 4, check_in_date: '2026-07-01', check_in_time: '07:55:00', selfie_url: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=150', status: 'approved', reason: null }
  ],
