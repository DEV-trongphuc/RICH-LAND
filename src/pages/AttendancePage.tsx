                        ...
                        return (
                          <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', marginTop: '4px' }}>
                                ...
                                >
                                  ...
                                  {a.contact_id && (
                                    ...
                                    >
                                      ...
                                      <span style={{ fontSize: '0.6rem', fontWeight: 700, maxWidth: '40px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                                        {a.contact_name}
                                      </span>
                                    </div>
                                  )}
                            ...
                            {dayActivities.length > 3 && (
                              <div style={{ fontSize: '0.65rem', color: 'var(--color-text-muted)', fontWeight: 700, textAlign: 'center' }}>
