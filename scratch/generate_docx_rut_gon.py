...
def main():
    md_path = "markdown/15-bien-ban-nghiem-thu-rut-gon.md"
    docx_path = "markdown/15-bien-ban-nghiem-thu-rut-gon.docx"
    ...
    for section in doc.sections:
        ...
        hrun = header_p.add_run("BIÊN BẢN NGHIỆM THU RÚT GỌN CRM RICH LAND")
...
def render_table(doc, raw_rows):
    ...
    # Thiết lập độ rộng cột tối ưu cho Biên bản nghiệm thu (phát hiện bảng 6 cột, 3 cột hoặc 4 cột)
    col_widths = []
    if num_cols == 6:
        ...
        col_widths = [Inches(0.5), Inches(2.0), Inches(1.2), Inches(3.8)]
    else:
    ...
    for r_idx, row in enumerate(table.rows):
        ...
        for c_idx, cell in enumerate(row.cells):
            ...
            if r_idx == 0:
                # Dòng đầu tiên (HEADER): KHÔNG ĐỔ MÀU NỀN
                ...
                if (num_cols == 6 and (c_idx == 0 or c_idx == 4)) or (num_cols == 4 and (c_idx == 0 or c_idx == 2)):
                    p.alignment = WD_ALIGN_PARAGRAPH.CENTER
