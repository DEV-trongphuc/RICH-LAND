...
$t1 = microtime(true);
$cRes = $conn->query("SELECT id, first_name, last_name, phone FROM contacts ORDER BY id DESC LIMIT 50");
$t2 = microtime(true);
...
$t1 = microtime(true);
$lRes = $conn->query("SELECT id, name, phone, status FROM leads ORDER BY id DESC LIMIT 50");
$t2 = microtime(true);
